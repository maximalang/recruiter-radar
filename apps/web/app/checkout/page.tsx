        ...
        <ContentCard>
          ...
          {!isRequest ? (
            <div className={ipStyles.bodyTextMutedBlock} style={{ marginTop: 16 }}>
              <strong>Получение услуги.</strong> Физической доставки нет. После успешной оплаты откроется настройка профиля в личном кабинете. Радар формируется после заполнения профиля и подключения выбранного канала доставки на основании доступных сигналов. Чек НПД направляется в электронной форме.
            </div>
          ) : null}
