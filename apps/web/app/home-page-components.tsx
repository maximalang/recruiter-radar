...
export function buildFaqItems(paymentConfigured: boolean) {
  return [
    ...
    },
    {
      ...
      answer: "Из открытых карьерных страниц и вакансий. Мы подтверждаем найм, оцениваем уверенность (A–D) и подбираем безопасный путь контакта — без агрегаторов «возможно, нанимают»."
    },
    {
