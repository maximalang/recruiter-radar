...
export function buildFaqItems(paymentConfigured: boolean) {
  return [
    ...
    {
      question: "Как устроена доставка в Telegram?",
      answer: "Утром приходит короткий список из 3–7 приоритетных компаний. В карточке можно отметить «беру в работу», «позже» или «не подходит», чтобы следующие рекомендации точнее соответствовали вашему профилю."
    },
    {
