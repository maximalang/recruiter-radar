...
export function buildFaqItems(paymentConfigured: boolean) {
  return [
    ...
    },
    {
      ...
      answer: "База показывает публикации. Recruiter Radar сопоставляет сигнал с профилем агентства, проверяет компанию и актуальность момента, применяет порог доверия и объясняет, почему этой компании стоит написать сейчас. Исходные факты, даты и источники остаются рядом с выводом."
    },
    {
