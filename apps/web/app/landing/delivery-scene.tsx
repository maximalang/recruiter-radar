...
const DELIVERY_STEPS = [
  ...
  { title: "Проверка и scoring", text: "Радар проверяет свежесть, динамику, соответствие и доступность корпоративного контакта." },
  { title: "Короткая выдача", text: "Вместо потока вакансий — несколько компаний с объяснением приоритета." },
  { title: "Подключённый канал", text: "В пилоте радар приходит в Telegram; email подключается по запросу." },
        ...
        <div className={styles.deliveryDemo}>
          <div className={styles.deliveryChannel}>
            ...
            <dl>
              ...
              <div><dt>Следующий шаг</dt><dd>Открыть evidence ledger и выбрать корпоративный путь контакта.</dd></div>
            </dl>
          </div>
          <aside className={styles.deliveryBoundary}>
            <span>Граница автоматизации</span>
            <strong>Радар доставляет рекомендацию. Не сообщение компании.</strong>
