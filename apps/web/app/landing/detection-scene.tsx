    ...
    >
      ...
      <div className={`${styles.detectionCopy} ${sceneStyles.copy}`}>
        ...
        <p className={styles.heroDescription}>
          Recruiter Radar превращает вакансии, изменения карьерных страниц и динамику найма в короткий список клиентских возможностей. Кому написать сегодня, почему именно сейчас и на какие факты сослаться — видно сразу.
        </p>
