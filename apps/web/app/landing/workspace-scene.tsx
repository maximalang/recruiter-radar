...
export default async function WorkspaceScene(props: {
  ...
  return (
    <section
      id="scene-workspace"
      className={`${styles.scene} ${styles.lightScene} ${styles.workspaceScene}`}
      ...
      <div className={styles.workspaceLayout} data-preview-section-content>
        ...
        <div className={styles.workspaceIntro}>
          ...
          <h2 id="workspace-title" className={styles.sceneHeading}>
            Не обещание продукта, а <em>рабочий preview.</em>
          </h2>
          <p className={styles.sceneLead}>
            Укажите специализацию и географию. Серверный preview пересчитает порядок компаний и покажет факты, оценку и безопасный следующий шаг.
          </p>
        </div>
        ...
        <div className={styles.workspaceProductFrame}>
          ...
          <div id="preview-results" className={styles.workspaceResults} data-preview-results>
            <div className={styles.workspaceResultsHeader}>
              <div>
                <span>PREVIEW / {String(previewState.items.length).padStart(2, "0")}</span>
  ...
  return (
    ...
    >
      <div className={styles.workspaceLayout} data-preview-section-content aria-busy="true">
        <div className={styles.workspaceIntro}>
          <p className={styles.sceneLabel}>03 — Интерактивный пример</p>
          <h2 id="workspace-loading-title" className={styles.sceneHeading}>Рабочий preview под вашу специализацию.</h2>
        </div>
        <div className={styles.workspaceProductFrame}>
          <div className={styles.workspaceSkeletonLine} data-preview-configurator-skeleton />
          <div className={styles.workspaceSkeleton} data-preview-results-skeleton>
            <span /><span /><span />
          </div>
        </div>
      </div>
