        ...
        <div className={s.docBody}>
          ...
          <ConsentSection n="5" title="Получатели и обработчики">
            <ul className={s.docList}>
              ...
              <li><strong>Яндекс.Облако (сервис Postbox):</strong> коды входа, статусы заказа, чек и ответы поддержки;</li>
          ...
          <ConsentSection n="6" title="Что не входит в это согласие">
            ...
            <p>Рекламные (промо) рассылки сервисом не выполняются и в это согласие не входят; передача данных для рекламы также не предусмотрена.</p>
          </ConsentSection>
