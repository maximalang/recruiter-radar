        ...
        <div className={s.docBody}>
          ...
          <TermsSection n="5" title="Передача данных третьим лицам">
            ...
            <ul className={s.docList}>
              ...
              <li><strong>Яндекс Метрика</strong> — только на публичной главной странице для оценки посещаемости. Webvisor, clickmap и отслеживание ссылок отключены; формы, параметры профиля, e-mail, заказы и данные личного кабинета в Метрику не передаются.</li>
            </ul>
