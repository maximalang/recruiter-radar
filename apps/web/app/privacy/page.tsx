    ...
    <PageFrame maxWidth="760px">
      <section className={s.docSection}>
        ...
        <p className={s.docOperator}>
          Оператор: <strong>{OPERATOR.fullName}</strong>, самозанятый, ИНН {OPERATOR.inn}. Редакция от 26 июля 2026 года.
        </p>
        ...
        <div className={s.docBody}>
          ...
          <TermsSection n="2" title="Какие данные обрабатываются">
            ...
            <ul className={s.docList}>
              ...
              <li><strong>Технические данные</strong> — подписанный идентификатор сессии (cookie), необходимый для работы личного кабинета, а на публичной главной странице — обезличенные технические данные посещения в Яндекс Метрике.</li>
            </ul>
          ...
          <TermsSection n="5" title="Передача данных третьим лицам">
            ...
            <ul className={s.docList}>
              ...
              <li><strong>Яндекс Метрика</strong> — только на публичном лендинге для оценки посещаемости. Метрика не используется в dashboard, leads, admin, profile, checkout и onboarding. Webvisor, clickmap и trackLinks отключены; параметры профиля, e-mail и данные заказа в Метрику не передаются.</li>
            </ul>
            <p>Внутренняя продуктовая telemetry принимает только разрешённые технические события и не содержит пользовательских полей.</p>
          ...
          <TermsSection n="9" title="Cookies">
            ...
            На публичной главной странице Яндекс Метрика может использовать технические
            cookie; пользователь может ограничить их средствами браузера. Отключение
            сессионных cookies может ограничить работу личного кабинета.
          </TermsSection>
