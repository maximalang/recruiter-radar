      ...
      <section style={{ display: "grid", gap: "18px", padding: "32px 0" }}>
        ...
        <SurfaceCard>
          <TermsSection n="2" title="Тарифы и оплата">
            ...
            <ul style={{ margin: "8px 0", paddingLeft: "20px", display: "grid", gap: "6px" }}>
              <li><strong>Пилот</strong> — 2 990 ₽, доступ на 7–14 дней, разовая оплата.</li>
              <li><strong>Месяц</strong> — 14 990 ₽, доступ на 30 дней.</li>
              <li><strong>Год</strong> — 89 990 ₽, доступ на 365 дней (экономия 89 890 ₽).</li>
            </ul>
        ...
        <SurfaceCard>
          <TermsSection n="4" title="Срок и прекращение">
            Пилот действует 7–14 дней с момента активации. Тарифы «Месяц» и «Год» действуют до конца оплаченного
            периода (30 и 365 дней соответственно). Заказчик вправе не продлевать тариф по истечении оплаченного
