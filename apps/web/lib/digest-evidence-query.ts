...
export const DIGEST_EVIDENCE_QUERY = String.raw`WITH source_signal_rows AS (
  SELECT
    ...
    (signal.source IN ('funding-business-signals', 'fedresurs', 'transparent-business-fns', 'egrul-fns', 'company-site', 'company-newsrooms', 'industry-media', 'fns-open-data', 'government-procurement', 'cbr-registry', 'rosstat-open-data', 'rospatent-open-data')) AS is_context_evidence
  ...
  WHERE
    ...
    (
      ...
      signal.signal_type IN ('other', 'funding')
        AND signal.source IN ('funding-business-signals', 'fedresurs', 'transparent-business-fns', 'egrul-fns', 'company-site', 'company-newsrooms', 'industry-media', 'fns-open-data', 'government-procurement', 'cbr-registry', 'rosstat-open-data', 'rospatent-open-data')
    )
),
