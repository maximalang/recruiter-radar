...
export const PUBLIC_PLANS: PublicPlan[] = [
  {
    ...
    currency: "RUB",
    price: "2 990 ₽",
    description: "Короткий запуск: за неделю увидите компании, которым стоит написать сегодня, — с доказательствами найма, оценкой уверенности и безопасным поводом для контакта.",
  ...
  },
  {
    ...
    currency: "RUB",
    price: "14 990 ₽/мес",
    description: "Полный доступ к радару на месяц. Тот же набор возможностей — на срок, удобный для проверки канала.",
    bullets: SHARED_PLAN_BULLETS,
  ...
  },
  {
    ...
    currency: "RUB",
    price: "29 990 ₽/3 мес",
    description: "Доступ на квартал со скидкой — выгоднее помесячной оплаты (~9 997 ₽/мес). Для команды, которая делает радар рабочим каналом на три месяца.",
    bullets: SHARED_PLAN_BULLETS,
