 ...
 *
 * Phase 4 (T4.3) — ConfidenceMeter on mobile keeps the band label visible and moves
...
import { ConfidenceMeter } from '@/app/ui/internal-page';

describe('ConfidenceMeter (T4.3 — level sr-only on mobile)', () => {
  it('renders the level label with the sr-only-on-mobile class', () => {
    const { container } = render(<ConfidenceMeter score={320} />);
