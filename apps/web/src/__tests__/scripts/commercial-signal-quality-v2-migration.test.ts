...
const migration = fs.readFileSync(path.join(
  root,
  'packages/db/migrations/20260809130000_add_commercial_signal_quality_v2.sql',
), 'utf8')
const rollback = fs.readFileSync(path.join(
  root,
  'packages/db/migrations/20260809130000_add_commercial_signal_quality_v2.down.sql',
), 'utf8')
