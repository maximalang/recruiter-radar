...
const migration = fs.readFileSync(path.join(
  root,
  'packages/db/migrations/20260809140000_add_query_plan_quality_feedback_v2.sql',
), 'utf8')
const rollback = fs.readFileSync(path.join(
  root,
  'packages/db/migrations/20260809140000_add_query_plan_quality_feedback_v2.down.sql',
), 'utf8')
