...
try {
  ...
  await run(process.execPath, [
    ...
    '--runInBand',
    '--runTestsByPath',
    'src/__tests__/lib/opportunities/commercial-thesis-runtime-db.test.ts',
  ], webRoot)
