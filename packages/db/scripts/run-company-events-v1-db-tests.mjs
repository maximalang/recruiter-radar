...
try {
  ...
  await run(process.execPath, [
    ...
    '--runInBand',
    '--runTestsByPath',
    'src/__tests__/lib/opportunities/company-events-runtime-db.test.ts',
  ], webRoot)
